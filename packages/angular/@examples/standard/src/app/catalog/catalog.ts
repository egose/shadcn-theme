...
export const CATALOG_ENTRIES: CatalogEntry[] = [
  ...
  {
    slug: 'form-date-picker-multi',
    title: 'Form Date Picker Multi',
    category: 'Forms & Inputs',
    kind: 'component',
    description: 'Pick multiple dates with integrated form labels and errors.',
    icon: lucideCalendar,
    load: () =>
      import('../pages/components/form-date-picker-multi/form-date-picker-multi').then(
        (m) => m.FormDatePickerMultiPage,
      ),
  },
  {
    ...
    category: 'Forms & Inputs',
    kind: 'component',
    description: 'Pick a date range with integrated form labels and errors.',
    icon: lucideCalendar,
    load: () =>
      import('../pages/components/form-date-range-picker/form-date-range-picker').then(
        (m) => m.FormDateRangePickerPage,
      ),
  },
  {
    slug: 'form-month-year-picker',
    title: 'Form Month Year Picker',
    category: 'Forms & Inputs',
    kind: 'component',
    description: 'Pick a month and year with integrated form labels and errors.',
    icon: lucideCalendar,
    load: () =>
      import('../pages/components/form-month-year-picker/form-month-year-picker').then(
        (m) => m.FormMonthYearPickerPage,
      ),
  },
  {
  ...
  },
  {
    ...
    category: 'Forms & Inputs',
    kind: 'component',
    description: 'Collect masked phone numbers with integrated form labels and errors.',
    icon: lucideTextCursorInput,
    load: () => import('../pages/components/form-phone-input/form-phone-input').then((m) => m.FormPhoneInputPage),
  },
  {
    ...
    category: 'Forms & Inputs',
    kind: 'component',
    description: 'Search and pick a value with integrated form labels and errors.',
    icon: lucideSearch,
    load: () => import('../pages/components/form-autocomplete/form-autocomplete').then((m) => m.FormAutocompletePage),
  },
  {
    slug: 'form-combobox',
    title: 'Form Combobox',
    category: 'Forms & Inputs',
    kind: 'component',
    description: 'Multi-select with chips and integrated form labels and errors.',
    icon: lucideLayers,
    load: () => import('../pages/components/form-combobox/form-combobox').then((m) => m.FormComboboxPage),
  },
  {
    slug: 'form-input-otp',
    ...
    category: 'Forms & Inputs',
    kind: 'component',
    description: 'Collect one-time codes with integrated form labels and errors.',
    icon: lucideKeyboard,
    load: () => import('../pages/components/form-input-otp/form-input-otp').then((m) => m.FormInputOtpPage),
  },
  {
    slug: 'form-native-select',
    title: 'Form Native Select',
    category: 'Forms & Inputs',
    kind: 'component',
    description: 'Bind a platform select to a labeled, validated form field.',
    icon: lucideMenu,
    load: () => import('../pages/components/form-native-select/form-native-select').then((m) => m.FormNativeSelectPage),
  },
  {
    slug: 'form-radio-group',
    title: 'Form Radio Group',
    category: 'Forms & Inputs',
    kind: 'component',
    description: 'Bind a radio choice to a labeled, validated form field.',
    icon: lucideList,
    load: () => import('../pages/components/form-radio-group/form-radio-group').then((m) => m.FormRadioGroupPage),
  },
  {
    slug: 'form-slider',
    title: 'Form Slider',
    category: 'Forms & Inputs',
    kind: 'component',
    description: 'Bind a numeric slider to a labeled, validated form field.',
    icon: lucideSlidersHorizontal,
    load: () => import('../pages/components/form-slider/form-slider').then((m) => m.FormSliderPage),
  },
  {
    slug: 'form-switch',
    title: 'Form Switch',
    category: 'Forms & Inputs',
    kind: 'component',
    description: 'Bind an on/off switch to a labeled, validated form field.',
    icon: lucideToggleLeft,
    load: () => import('../pages/components/form-switch/form-switch').then((m) => m.FormSwitchPage),
  },
  {
    slug: 'form-toggle',
    title: 'Form Toggle',
    category: 'Forms & Inputs',
    kind: 'component',
    description: 'Bind a toggle button to a labeled, validated form field.',
    icon: lucideToggleLeft,
    load: () => import('../pages/components/form-toggle/form-toggle').then((m) => m.FormTogglePage),
  },
  {
    slug: 'form-toggle-group',
    title: 'Form Toggle Group',
    category: 'Forms & Inputs',
    kind: 'component',
    description: 'Bind an option button group to a labeled, validated form field.',
    icon: lucideToggleLeft,
    load: () => import('../pages/components/form-toggle-group/form-toggle-group').then((m) => m.FormToggleGroupPage),
  },
