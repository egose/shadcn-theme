...
import { HlmAutocompleteEmpty } from './autocomplete-empty';
import { HlmAutocompleteGroup } from './autocomplete-group';
import { HlmAutocompleteItem } from './autocomplete-item';
import { HlmAutocompleteList } from './autocomplete-list';
import { HlmAutocompleteSearch } from './autocomplete-search';
import { HlmAutocompleteSearchInput } from './autocomplete-search-input';
import { HlmAutocompleteTrigger } from './autocomplete-trigger';
import { injectHlmAutocompleteConfig } from './autocomplete.token';
...
export class HlmAutocomplete<T> implements ControlValueAccessor {
  ...
  protected readonly _computedClass = computed(() => hlm('tw:block tw:w-full', this.userClass()));
