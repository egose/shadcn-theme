...
export default function Page() {
  return (
    <ExamplePage
      title="Context Menu"
      description="A modal menu surfaced on right-click or long-press to expose contextual actions."
    >
      <ExampleSection
        title="Browser-style Menu"
        description="Supports items, sub-menus, checkboxes, radio groups, and shortcuts."
      >
        <ContextMenu>
