...
export default function Page() {
  ...
  return (
    <ExamplePage
      title="Collapsible"
      description="An interactive component that expands and collapses a region of content."
    >
      <ExampleSection title="Order Details" description="Toggle the visibility of additional order information.">
