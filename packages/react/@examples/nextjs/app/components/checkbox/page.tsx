...
export default function Page() {
  return (
    <ExamplePage
      title="Checkbox"
      description="Checkboxes capture boolean consent and selection state with accessible labeling."
    >
      <ExampleSection
        title="Common field patterns"
        description="Pair the checkbox with a label, helper text, or disabled state depending on context."
      >
